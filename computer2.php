            ...
            <div style='float:center'>
                <table class = "table" border = "6">
                    <tr>
                        ...
                        Με το εκπληκτικό τσιπ M1 Pro ή M1 Max -το πρώτο KG silicon σχεδιασμένο για επαγγελματίες- 
                        έχει πρωτοποριακές επιδόσεις <br/>
                        και εκπληκτική διάρκεια ζωής της μπαταρίας -συνδεδεμένο ή όχι. Με μια εκπληκτική οθόνη Liquid Retina XDR, 
                        την καλύτερη κάμερα <br/>
